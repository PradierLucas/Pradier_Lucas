...
select concat(empleados.nombre,", ", empleados.apellido) as empleado, departamentos.nombre as departamento, departamentos.presupuesto  
from empleados inner join departamentos on empleados.departamento = departamentos.departamento_id; 
...
select departamentos.nombre as departamento,  empleados.apellido, empleados.nombre
 from empleados inner join departamentos on empleados.departamento = departamentos.departamento_id
...
select distinct departamento_id, departamentos.nombre from departamentos inner join empleados on departamentos.departamento_id = empleados.departamento;

-- v) Devuelve el nombre del departamento donde trabaja el empleado que tiene el cuit 27-38382980-3.
select  departamentos.nombre from departamentos inner join empleados on departamentos.departamento_id = empleados.departamento
...
select empleados.apellido, empleados.nombre from empleados inner join departamentos on departamentos.departamento_id = empleados.departamento 
...
select empleados.nombre from empleados inner join departamentos on departamentos.departamento_id = empleados.departamento 
